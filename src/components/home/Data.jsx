...
const Data = () => {
    ...
    const toRotate = [ "Web Developer" , "Cyber Security" , "Mobile App Developer" , "Digital Artist" ];
  ...
  return (
    <div className="home__data">
        ...
        <h3 className="home__subtitle"><span>{text}</span></h3>
        <p className="home__description">I'm currently Final year student @ KCT <br />my abilities lies in my openness to new ideas, and driving innovations , 
       complemented by good communication skills and unwavering confidence, and I'm dedicated to self-learning. <br /> This things fuels my growth to next levels.</p>
