...
export const homeHeading = `text-5xl md:text-6xl leading-tight mt-2 mb-4 ${titleHighlight}`
...
export const skillsPrimaryGrid = 'grid grid-cols-2 sm:grid-cols-5 gap-3'
...
export const skillsSecondaryWrap = 'grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-5 mb-12'
...
export const contactInfoValue = 'text-sm text-[var(--text-muted)]'
...
export const footerNav = 'flex gap-8 flex-wrap justify-center'
